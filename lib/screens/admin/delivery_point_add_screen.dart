...
class DeliveryPointAddScreen extends StatefulWidget {
  final int loadId;

  const DeliveryPointAddScreen({
    super.key,
    required this.loadId,
  });

  @override
  State<DeliveryPointAddScreen> createState() => _DeliveryPointAddScreenState();
}

class _DeliveryPointAddScreenState extends State<DeliveryPointAddScreen> {
  ...
  Future<void> _saveDeliveryPoint() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted) {
        ...
        // Create delivery point object to return
        final deliveryPoint = {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Teslimat noktası başarıyla eklendi'),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(
                            ...
                            hintText: 'Adana Lojistik Merkezi',
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Kaydet Butonu
                      ElevatedButton(
                        onPressed: _isLoading ? null : _saveDeliveryPoint,
